...
# BUI-463: the comics-server dir migration (BUI-220) has now been performed
# on the Mac Mini — live LaunchAgent label is com.comics.server and the data
# dir is ~/.comics-server (docs/runbooks/comics-server-dir-migration.md).
